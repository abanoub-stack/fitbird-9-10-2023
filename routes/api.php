...
Route::middleware(['api-auth'])->group(function () {
    ...
    Route::post('subscribe-three-months', [V1StripePaymentController::class, 'subscribeThreeMonths']);
    Route::post('subscribe-six-months', [V1StripePaymentController::class, 'subscribeSixMonths']);
