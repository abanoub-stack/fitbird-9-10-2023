...
class Kernel extends HttpKernel
{
    ...
    {
        $schedule->command('minute:logout')
            ->everyMinute();
    }
    /**
    ...
    protected $routeMiddleware = [
        ...
        'has-credit' => \App\Http\Middleware\HasCredit::class,
        'dont-has-credit' => \App\Http\Middleware\HasNoCredit::class,
        // 'api-schedule' => App\Console\Commands\AuthSchedule::class,
